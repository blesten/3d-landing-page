  ...
  return (
    <Canvas camera={{ position: [2.5, 1, 0], fov: 50 }} shadows>
      <Suspense fallback={null}>
        ...
        <directionalLight castShadow lookAt={[0,0,0]} position={[1,1,1]} intensity={.6} />
        ...
        <Skateboard
          ...
          pose='side'
        />
        <CameraControls onStart={onCameraControlStart} ref={cameraControls} minDistance={.2} maxDistance={4} />
      </Suspense>
      <Preload all />
    </Canvas>
  )
