  ...
  return (
    ...
    >
      <div className='absolute inset-0 flex items-center pt-20'>
        <WideLogo className='w-full text-brand-purple hidden opacity-20 mix-blen-multiply lg:block' />
        <TallLogo className='w-full text-brand-purple opacity-20 mix-blen-multiply lg:hidden' />
      </div>
